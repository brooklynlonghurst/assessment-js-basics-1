...
// CODE HERE
    //add all acres from each kind of apple
    //fujiAcres = 15, galaAcres = 26, pinkAcres = 22
...
// how to sum numbers of multiple arrays or variables? 
...
// CODE HERE
let allAcres = []
allAcres += totalFuji + totalGala + totalPink
...
// for(let i = 0; i < acresLeft.length; i++){
// } this might be inside the while loop 
